  ...
  return (
    <Modal onClose={props.onClose}>
      <div className="flex flex-col">
        ...
        {!showUserOptions && (
          <div className="flex flex-col space-y-8 w-[80vw] pb-10">
            {/* User photo */}
            ...
            <a
              className="flex-1 w-[70vw] mx-auto px-14 py-2 border border-black text-center uppercase shadow-md"
              target="_blank"
        ...
        {showUserOptions && (
          <div className="flex flex-col space-y-8 w-[80vw] pb-10 pt-3">
            <button
              onClick={userRollHandler}
              type="button"
              name="admin"
